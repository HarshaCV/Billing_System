...
class Bill_App:
	def __init__(self,root):
		...
		bg_color='#ffffff'
		title=Label(self.root,text="BILLING SYSTEM",bd=15,bg=bg_color,fg="black",font=("times new roman",30,"bold"),pady=2).pack(fill=X)
		#================Variables==========================
		#================Cosmetics==========================
		...
		F1=LabelFrame(self.root,bd=8,text="Customer Details",font=("times new roman",15,"bold"),fg="darkorange",bg=bg_color)
		...
		cname_txt=Entry(F1,width=15,textvariable=self.c_name,font="arial 15",bd=7,relief=RIDGE).grid(row=0,column=1,pady=5,padx=10)

		cphn_lbl=Label(F1,text="Contact No",bg=bg_color,fg="black",font=("times new roman",18,"bold")).grid(row=0,column=2,padx=20,pady=5)
		cphn_txt=Entry(F1,width=15,textvariable=self.c_phon,font="arial 15",bd=7,relief=RIDGE).grid(row=0,column=3,pady=5,padx=10)
		...
		c_bill_txt=Entry(F1,width=15,textvariable=self.search_bill,font="arial 16",bd=7,relief=RIDGE).grid(row=0,column=5,pady=5,padx=10)

		bill_btn=Button(F1,text="Search",command=self.find_bill,width=10,bd=7,font=("times new roman",16,"bold")).grid(row=0,column=6,padx=6,pady=10)


		#===================Cosmetics Frame==========
		
		F2=LabelFrame(self.root,bd=8,text="Cosmetics",font=("times new roman",15,"bold"),fg="darkorange",bg=bg_color)
		...
		Body_lbl=Label(F2,text="Lotions",font=("times new roman",16,"bold"),bg=bg_color,fg="black").grid(row=5,column=0,padx=10,pady=10,sticky="w")
		...
		F3=LabelFrame(self.root,bd=8,text="Groceries",font=("times new roman",15,"bold"),fg="darkorange",bg=bg_color)
		...
		g3_lbl=Label(F3,text="Dal",font=("times new roman",16,"bold"),bg=bg_color,fg="black").grid(row=2,column=0,padx=10,pady=10,sticky="w")
		...
		F4=LabelFrame(self.root,bd=8,text="Cold Drinks",font=("times new roman",15,"bold"),fg="darkorange",bg=bg_color)
		F4.place(x=675,y=180,width=325,height=380)

		c1_lbl=Label(F4,text="Slice",font=("times new roman",16,"bold"),bg=bg_color,fg="black").grid(row=0,column=0,padx=10,pady=10,sticky="w")
		...
		c2_lbl=Label(F4,text="Coca Cola",font=("times new roman",16,"bold"),bg=bg_color,fg="black").grid(row=1,column=0,padx=10,pady=10,sticky="w")
		...
		F6=LabelFrame(self.root,bd=8,text="BILL MENU",font=("times new roman",15,"bold"),fg="darkorange",bg=bg_color)
		F6.place(x=0,y=560,relwidth=1,height=140)
		m1_lbl=Label(F6,text="Total Cosmetics Price",bg=bg_color,fg="black",font=("times new roman",15,"bold")).grid(row=0,column=0,padx=20,pady=1,sticky="w")
		m1_txt=Entry(F6,width=18,textvariable=self.cosemtic_price,font="arial 10 bold",bd=7,relief=GROOVE).grid(row=0,column=1,padx=10,pady=1)

		m2_lbl=Label(F6,text="Total Grocery Price",bg=bg_color,fg="black",font=("times new roman",15,"bold")).grid(row=1,column=0,padx=20,pady=1,sticky="w")
		...
		m3_lbl=Label(F6,text="Total Cold Drink Price",bg=bg_color,fg="black",font=("times new roman",15,"bold")).grid(row=2,column=0,padx=20,pady=1,sticky="w")
		...
		c1_lbl=Label(F6,text="Cosmetics Tax",bg=bg_color,fg="black",font=("times new roman",15,"bold")).grid(row=0,column=2,padx=20,pady=1,sticky="w")
		c1_txt=Entry(F6,width=18,textvariable=self.cosemetic_tax,font="arial 10 bold",bd=7,relief=GROOVE).grid(row=0,column=3,padx=10,pady=1)
		...
		c2_txt=Entry(F6,width=18,textvariable=self.grocery_tax,font="arial 10 bold",bd=7,relief=GROOVE).grid(row=1,column=3,padx=10,pady=1)

		c3_lbl=Label(F6,text="Cold Drink Tax",bg=bg_color,fg="black",font=("times new roman",15,"bold")).grid(row=2,column=2,padx=20,pady=1,sticky="w")
		c3_txt=Entry(F6,width=18,textvariable=self.cold_drink_tax,font="arial 10 bold",bd=7,relief=GROOVE).grid(row=2,column=3,padx=10,pady=1)


		btn_F=Frame(F6,bd=7,relief=GROOVE)
		btn_F.place(x=740,width=590,height=102)

		total_btn=Button(btn_F,text="Total",command=self.total,bg="white",fg="green",pady=15,bd=4,width=10,font="arial 14 bold").grid(row=0,column=0,padx=5,pady=5)
		GBill_btn=Button(btn_F,text="Generate Bill",command=self.bill_area,bg="white",fg="navyblue",pady=15,bd=4,width=10,font="arial 14 bold").grid(row=0,column=1,padx=5,pady=5)
		Clear_btn=Button(btn_F,text="Clear",command=self.clear_data,bg="white",fg="red",pady=15,bd=4,width=10,font="arial 14 bold").grid(row=0,column=2,padx=5,pady=5)
		Exit_btn=Button(btn_F,text="Exit",command=self.Exit_app,bg="white",fg="black",pady=15,bd=4,width=10,font="arial 14 bold").grid(row=0,column=3,padx=4,pady=5)
...
#=============functions for working=============================
	...
	def welcome_bill(self):
		...
		self.txtarea.insert(END,"\t Billing Details\n")
	...
	def bill_area(self):
		if self.c_name.get()=="" or self.c_phon.get()=="":
			...
			if self.lotion.get()!=0:
				self.txtarea.insert(END,f"\n Lotions\t\t{self.lotion.get()}\t\t{self.c_bl_p}")
			...
			#========Cold Drinks==========
			if self.maza.get()!=0:
				self.txtarea.insert(END,f"\n slice\t\t{self.maza.get()}\t\t{self.d_m_p}")
